...
<body class="g-sidenav-show">
    ...
    border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
        ...
        <ul class="navbar-nav mb-3">
            @if(!auth()->check())
            <li class="nav-item">
                <a class="nav-link text-white bg-gradient-info" href="{{route('login')}}">
                    <span class="nav-link-text ms-1 font-weight-bolder">
                        Đăng nhập
                    </span>
                </a>
            </li>
            @else
            <li class="nav-item">
                <a class="nav-link text-white bg-gradient-info" href="{{route('logout')}}">
                    <span class="nav-link-text ms-1 font-weight-bolder">
                        Đăng xuất
                    </span>
                </a>
        ...
        <div class="w-auto overflow-auto" style="max-height: 60%!important">
            <ul class="navbar-nav">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Học phần</h6>
                </li>
                <li class="nav-item">
